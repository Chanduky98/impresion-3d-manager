...
INSERT INTO "new_Piece" ("createdAt", "customSellingPrice", "description", "estimatedTime", "fileName", "fileSize", "id", "isPersonal", "materialId", "name", "status", "updatedAt", "weight") SELECT "createdAt", "customSellingPrice", "description", "estimatedTime", "fileName", "fileSize", "id", "isPersonal", "materialId", "name", "status", "updatedAt", "weight" FROM "Piece";
DROP TABLE "Piece";
