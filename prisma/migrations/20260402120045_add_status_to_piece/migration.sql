...
INSERT INTO "new_Piece" ("createdAt", "description", "estimatedTime", "fileName", "fileSize", "id", "materialId", "name", "updatedAt", "weight") SELECT "createdAt", "description", "estimatedTime", "fileName", "fileSize", "id", "materialId", "name", "updatedAt", "weight" FROM "Piece";
DROP TABLE "Piece";
